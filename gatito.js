...
function componentes(){
   ...
   for (let index = 1; index <=9; index++) {
      $('.row').append('<div class="cuadro heigh clic" data-value="0" id="'+index+'"></div>');
   }
   juego();
}
var conJugador1=0;
...
$('#butti').one("click",function(){
   if ($(".container").attr("class"))
   {
      $(".container").css("display", "block");
      $("#posv").css("display", "none");
      $("#butti").css("display", "none");
      $("#textillo").css("display", "none");
      }
   });
